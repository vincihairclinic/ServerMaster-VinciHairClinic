 ...
 * @package App\Models
 */
class BookPostAdditional extends ModelBase
{
    protected $table = 'book_post_additionals';
    ...
    public function book_post_additional_items()
    {
        return $this->hasMany(BookPostAdditionalItem::class);
    }
}