 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function pushLoad($name)
        {
                        return \App\Application::pushLoad($name);
        }
                    /**
         * 
         *
        ...
        {
                        return \App\Application::getProxy();
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getDescriptionServer()
        {
                        return \App\Application::getDescriptionServer();
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function storageImageAsset($filePath = '')
        {
                        return \App\Application::storageImageAsset($filePath);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function storageFileAsset($filePath = '')
        {
                        return \App\Application::storageFileAsset($filePath);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function storageAsset($filePath = '', $type = 'image')
        {
                        return \App\Application::storageAsset($filePath, $type);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function getScore($max_bpm, $avg_bpm)
        {
                        return \App\Application::getScore($max_bpm, $avg_bpm);
        }
                    /**
...
')
     ...
     */ 
         ...
         * 
         *
         * @param \CloudConvert\OptionsResolver $resolver
         * @static 
         */ 
        public static function configureOptions($resolver)
        {
                        /** @var \CloudConvert\CloudConvert $instance */
                        return $instance->configureOptions($resolver);
        }
                    /**
         * 
         *
         * @return \CloudConvert\HttpTransport 
         * @static 
         */ 
        public static function getHttpTransport()
        {
                        /** @var \CloudConvert\CloudConvert $instance */
                        return $instance->getHttpTransport();
        }
                    /**
         * 
         *
         * @return \CloudConvert\HydratorInterface 
         * @static 
         */ 
        public static function getHydrator()
        {
                        /** @var \CloudConvert\CloudConvert $instance */
                        return $instance->getHydrator();
        }
                    /**
         * 
         *
         * @return \CloudConvert\UsersResource 
         * @static 
         */ 
         ...
         * 
         *
         * @return \CloudConvert\TasksResource 
         * @static 
         */ 
         ...
         * 
         *
         * @return \CloudConvert\JobsResource 
         * @static 
         */ 
         ...
         * 
         *
         * @return \CloudConvert\WebhookHandler 
         * @static 
         */ 
         ...
         * 
         *
         * @return \CloudConvert\SignedUrlBuilder 
         * @static 
         */ 
        public static function signedUrlBuilder()
        {
                        /** @var \CloudConvert\CloudConvert $instance */
                        return $instance->signedUrlBuilder();
        }
...
namespace  { 
            ...
            class CloudConvert extends \CloudConvert\Laravel\Facades\CloudConvert {}
