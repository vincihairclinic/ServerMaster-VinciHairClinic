...
@section('head_title') Podcasts episodes @endsection
@section('title') Podcasts episodes @endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <a href="{{ route('dashboard.podcast-episode.create') }}" class="btn btn-self-primary">Add podcast episode episodes</a>
        </div>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            dataTable = $('#data-table').DataTable({
                ajax: {
                    url: '{{ route('dashboard.podcast-episode.index-json') }}',
                    type: 'post'
                },
                order: [
                    [0, "desc"],
                ...
                columns: [
                    {
                        ...
                        render: function (data, type, row) {
                            return '<a class="btn btn-self-info py-1 px-0 text-center width-60" href="{{ route('dashboard.podcast-episode.index') }}/' + row.id + '/edit">Edit</button>' +
